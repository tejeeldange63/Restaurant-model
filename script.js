...
function  thankyouFnc(){
    return new Promise((resolve,reject)=>{
        setTimeout(()=>{
            ...
            thnksMsg.innerHTML += `<h2 style="color:green;">Order is delievered🎉🎉🎉🎉🎉. Visit Again, Thanks!!!</h2>
            <img src="https://www.sticker.com/picture_library/product_images/stock-message/72562_thank-you-for-your-order-stickers-and-labels.png" alt="thnksImg">
            `
            resolve(alert('Order is delievered🎉🎉🎉🎉🎉. Visit Again, Thanks!!!'))
        },1500)
    })
}
